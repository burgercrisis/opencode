...
describe("BunProc", () => {
  ...
  describe("which", () => {
    bulletproofTest("returns the current executable path", async () => {
  ...
  describe("install", () => {
    bulletproofTest("can install a package", async () => {
    ...
    bulletproofTest("can install with latest version", async () => {
      try {
