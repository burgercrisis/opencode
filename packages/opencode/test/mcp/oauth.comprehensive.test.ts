...
describe("OAuth System - Comprehensive Tests", () => {
  ...
  describe("OAuth Browser Integration", () => {
    ...
    bulletproofTest("should open browser with correct URL", async () => {
      const mockConfig = {
    ...
    bulletproofTest("should handle browser open failure gracefully", async () => {
      openShouldFail = true
    ...
    bulletproofTest("should handle OAuth callback correctly", async () => {
      const mockConfig = {
        clientId: "test-client",
        clientSecret: "test-secret",
        scope: "read write",
    ...
    bulletproofTest("should handle OAuth errors correctly", async () => {
      const mockConfig = {
        clientId: "test-client",
        clientSecret: "test-secret",
        scope: "read write",
