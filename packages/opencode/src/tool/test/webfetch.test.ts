...
describe("WebFetchTool", () => {
  ...
  bulletproofTest("should throw error for invalid URL", async () => {
    const init = await WebFetchTool.init()
  ...
  bulletproofTest("should throw error for ftp URL", async () => {
    const init = await WebFetchTool.init()
  ...
  bulletproofTest("should require url parameter", async () => {
    const init = await WebFetchTool.init()
  ...
  bulletproofTest("should accept optional format parameter", async () => {
    const init = await WebFetchTool.init()
  ...
  bulletproofTest("should accept valid format values", async () => {
    const init = await WebFetchTool.init()
