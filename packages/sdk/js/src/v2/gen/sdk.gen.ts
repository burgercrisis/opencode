...
<<<<<<< HEAD
   ...
   */
  public revertFiles<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
      messageID: string
      partID?: string
    ...
    return (options?.client ?? this.client).post<SessionRevertFilesResponses, SessionRevertFilesErrors, ThrowOnError>({
