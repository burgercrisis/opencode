...
export type SessionRevertFilesData = {
  ...
  url: "/session/{sessionID}/revert/files"
}

export type SessionRevertFilesErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type SessionRevertFilesError = SessionRevertFilesErrors[keyof SessionRevertFilesErrors]

export type SessionRevertFilesResponses = {
  /**
   * Updated session
   */
  200: Session
