...
export const { use: useFile, provider: FileProvider } = createSimpleContext({
  ...
  init: () => {
    ...
    const selection = (input: string) => view().selection(path.normalize(input))
    const folded = (input: string) => view().folded(path.normalize(input))
    const changeIndex = (input: string) => view().changeIndex(path.normalize(input))
    ...
    const setSelection = (input: string, selection: FileSelection | null) => {
      view().setSelection(path.normalize(input), selection)
    }
